...
import {Grid, Button, Typography, CircularProgress, Avatar} from '@material-ui/core';
  ...
  const handleChange =()=>{
    ...
    return(
      <MuiThemeProvider theme={THEME}>
        <Typography variant="h4" style={{margin:'0.3em 1.5em',fontWeight: 550}}>Leads</Typography>           
