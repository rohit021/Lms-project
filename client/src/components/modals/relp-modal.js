...
import { SourceOptions, CenterOptions, PriorityOptions, DepartmentOptions, PropertyNameOptions} from "../../helpers/utils";
...
const RelpModal = ({id, reload, status, closeModal, openModal, organization}) => {
