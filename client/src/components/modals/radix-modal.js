...
const ValidationSchema = yup.object().shape({
  radixDepartment: yup.string().required("This field is required"),
...
const RadixDetailsModal = ({ FormData, setFormData, handleBack, handleNext}) => {
  ...
  const DepartmentChange = (event) => {
    ...
    const DoctorList = DoctorOptions.filter(
            ...
            <Grid container spacing={2}>
              <Grid item md={12} xs={12} sm={12}>
                <FormControl className={classes.selectStyle}>
                  <TextField
                    ...
                    helperText={
                      errors.radixDepartment && touched.radixDepartment
                        ? errors.radixDepartment
                        : ""
                    }
                    onChange={(event) => {
              ...
              <Grid item md={12} xs={12} sm={12}>
                <TextField
                  ...
                  helperText={
                    errors.otherspecify && touched.otherspecify
                      ? errors.otherspecify
                      : ""
                  }
                  fullWidth
